...
/* Constants */
#define Nmax	32	/* Maximum number of processors */
#define Mmax	128	/* Maximum number of application's tasks/processes/SDR functions */

#define Wmax	32	/* Maximum number of processors */
