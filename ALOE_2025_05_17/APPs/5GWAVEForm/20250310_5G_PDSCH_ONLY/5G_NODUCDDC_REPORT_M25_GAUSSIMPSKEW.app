...
object {
	...
	outputs {
		name=output_2
		remote_itf=input_0
		remote_obj=GRAPH_DECODER0
	}
}
########################################
########################################
object {
	obj_name=LDPC5G_DECODER1
	exe_name=LDPC5G_DECODER
	force_pe=0
	inputs {
		name=input_0
