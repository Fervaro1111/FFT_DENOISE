...
typedef float  input_t;			//_Complex float, float, int, char, char
#define IN_TYPE			FLOAT		//COMPLEXFLOAT, FLOAT, INT, CHAR, BITS
#define INPUT_MAX_DATA 		10*2048
#define NOF_INPUT_ITF		2

//typedef _Complex float  output_t;
typedef float  output_t;			//_Complex float, float, int, char, char
#define OUT_TYPE		FLOAT		//COMPLEXFLOAT, FLOAT, INT, CHAR, BITS
