...
#include "Transform_Precoding_interfaces.h"
#include "Transform_Precoding_functions.h"
#include "Transform_Precoding.h"

//ALOE Module Defined Parameters. Do not delete.
char mname[STR_LEN]="Transform_Precoding";
int run_times=1;
...
int initialize() {
	...
	if (block_length > get_input_max_samples()) {
		...
		moderror("Check your Transform_Precoding_interfaces.h file\n");
		return -1;
	}
	/*Include the file name and line number when printing*/
