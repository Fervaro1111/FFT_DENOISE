...
#include "5G_RATE_MATCH_PBCH_interfaces.h"
#include "5G_RATE_MATCH_PBCH_functions.h"
#include "5G_RATE_MATCH_PBCH.h"
...
char mname[STR_LEN]="5G_RATE_MATCH_PBCH";
int run_times=1;
...
int initialize() {
	...
	param_get_int("TX_RX_mode", &TX_RX_mode);		//Initialized by
	...
	if (block_length > get_input_max_samples()) {
		...
		moderror("Check your 5G_RATE_MATCH_PBCH_interfaces.h file\n");
		return -1;
	}
	/*Include the file name and line number when printing*/
