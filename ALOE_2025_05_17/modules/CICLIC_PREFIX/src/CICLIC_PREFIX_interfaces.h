...
#define IN_TYPE			"COMPLEXFLOAT"		//COMPLEXFLOAT, FLOAT, INT, CHAR, BITS
#define INPUT_MAX_DATA 		14*4096
#define NOF_INPUT_ITF		1

//typedef _Complex float  output_t;
typedef _Complex float  output_t;			//_Complex float, float, int, char, char
#define OUT_TYPE		"COMPLEXFLOAT"		//COMPLEXFLOAT, FLOAT, INT, CHAR, BITS
#define OUTPUT_MAX_DATA 	15*4096
