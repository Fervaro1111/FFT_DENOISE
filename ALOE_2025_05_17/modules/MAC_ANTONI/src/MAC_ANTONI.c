...
#include "MAC_ANTONI_interfaces.h"
#include "MAC_ANTONI_functions.h"
#include "MAC_ANTONI.h"

//ALOE Module Defined Parameters. Do not delete.
char mname[STR_LEN]="MAC_ANTONI";
int run_times=1;
...
int TX_RX;
float coderate;
int QAM_order;//1 is BPSK,2=4AQM,4=16QAM,6=64QAM,8=256QAM
...
int frame_type=0;// 0 for short 1 for long
int frame_length=0; 
int free_RE_short=2280;
int free_RE_long=3240;
int MAX_block_size=1152;
...
int initialize() {
	...
	if (block_length > get_input_max_samples()) {
		...
		moderror("Check your MAC_ANTONI_interfaces.h file\n");
		return -1;
	}
	/*Include the file name and line number when printing*/
