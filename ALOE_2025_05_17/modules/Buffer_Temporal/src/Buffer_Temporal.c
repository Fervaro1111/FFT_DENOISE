...
#include "Buffer_Temporal_interfaces.h"
#include "Buffer_Temporal_functions.h"
#include "Buffer_Temporal.h"

//ALOE Module Defined Parameters. Do not delete.
char mname[STR_LEN]="Buffer_Temporal";
int run_times=1;
...
int initialize() {
	...
	if (block_length > get_input_max_samples()) {
		...
		moderror("Check your Buffer_Temporal_interfaces.h file\n");
		return -1;
	}
	/*Include the file name and line number when printing*/
