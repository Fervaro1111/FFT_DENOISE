...
#include "MODULPROVA_interfaces.h"
#include "MODULPROVA_functions.h"
#include "MODULPROVA.h"

//ALOE Module Defined Parameters. Do not delete.
char mname[STR_LEN]="MODULPROVA";
int run_times=1;
...
int initialize() {
	...
	if (block_length > get_input_max_samples()) {
		...
		moderror("Check your MODULPROVA_interfaces.h file\n");
		return -1;
	}
	/*Include the file name and line number when printing*/
