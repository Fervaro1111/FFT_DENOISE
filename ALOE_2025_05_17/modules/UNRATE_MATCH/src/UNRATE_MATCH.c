...
#include "UNRATE_MATCH_interfaces.h"
#include "UNRATE_MATCH_functions.h"
#include "UNRATE_MATCH.h"

//ALOE Module Defined Parameters. Do not delete.
char mname[STR_LEN]="UNRATE_MATCH";
int run_times=1;
...
int initialize() {
	...
	if (block_length > get_input_max_samples()) {
		...
		moderror("Check your UNRATE_MATCH_interfaces.h file\n");
		return -1;
	}
	/*Include the file name and line number when printing*/
