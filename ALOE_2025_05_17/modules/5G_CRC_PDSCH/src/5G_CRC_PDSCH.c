...
#include "5G_CRC_PDSCH_interfaces.h"
#include "5G_CRC_PDSCH_functions.h"
#include "5G_CRC_PDSCH.h"

extern MAC_struc MACinfo;

//ALOE Module Defined Parameters. Do not delete.
char mname[STR_LEN]="5G_CRC_PDSCH";
int run_times=1;
...
*/
	...
	//printf("-----------------RCVsamples at UNCRC=%i-------------\n",rcv_samples);
		...
		if(Tslot%10==0){
			...
			//printf("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
			//printf("!!! %s_PDSCH at Tslot=%d: BLER=%1.5f\n", mname, BLER,Tslot);
			//printf("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
		}
