...
extern int Z2;
extern int n_ite;
extern int enable_synd;
extern int synd_depth;
/* oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo */
/* Configure the control parameters */
#define NOF_PARAMS	14
...
param_t parameters[] = {
		...
		{"n_ite", INT, 1},				/* Maximum number of iterations */
		{"enable_synd", INT, 1},			/* 1 -> enable syndrome detection 0 -> disabled */
		{"synd_depth", INT, 1},				/* Syndrome detection depth */
		{"NofWINDOWsamples", INT, 1},		/* Histogram number of samples */
		{"TimeWINDOW_us", FLOAT, 1},			/* Time window ro visualize in us */
