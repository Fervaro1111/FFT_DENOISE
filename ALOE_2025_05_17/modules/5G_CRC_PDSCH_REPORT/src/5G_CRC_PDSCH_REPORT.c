...
#include "5G_CRC_PDSCH_REPORT_interfaces.h"
#include "5G_CRC_PDSCH_REPORT_functions.h"
#include "5G_CRC_PDSCH_REPORT.h"

extern MAC_struc MACinfo;

//ALOE Module Defined Parameters. Do not delete.
char mname[STR_LEN]="5G_CRC_PDSCH_REPORT";
int run_times=1;
...
*/
	...
	//CHECK CRC
	if(mode==CHECKCRC){
	//printf("%s-----------------RCVsamples at UNCRC=%i, Tslot=%d-------------\n",mname, rcv_samples, Tslot);
